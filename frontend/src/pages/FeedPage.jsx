      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-emerald-100 pt-5 relative z-10">
        ...
        <div className="flex flex-col items-center sm:items-end">
          <div className="flex items-center gap-1.5 text-emerald-700 mb-1">
            <FiUsers size={14}/>
            <span className="text-xs font-bold">{post.confirmations?.length || 0} family members</span>
          </div>
          <div className="flex -space-x-2">
            {post.confirmations?.map((person, i) => (
              <div key={i} className="w-8 h-8 rounded-full border-2 border-white bg-emerald-200 flex items-center justify-center text-[10px] font-bold text-emerald-700 shadow-sm" title={person.username}>
